 ...
 * </pre>
 */
public final class MyHttpClient implements HttpClient {
	 ...
	 * @return AndroidHttpClient for you to use for all your requests.
	 */
	public static MyHttpClient newInstance(String userAgent) {
	 ...
	 * @param level
	 *            at which to log messages (see
	 *            {@link com.whty.wicity.hb.common.Log})
	 */
	...
	public static boolean downloadFile(String url, File saveToFile) {
		...
		try {
			...
			final HttpClient httpClient = MyHttpClient.newInstance();
	 ...
	 * @return The content of the given URL, or null if error occurred.
	 */
	public static JSONObject getUrlAsJSONObject(String url) {
	 ...
	 * @return The content of the given URL, or null if error occurred.
	 */
	public static JSONArray getUrlAsJSONArray(String url) {
		final String json = getUrlAsString(url);
		if (json != null) {
			try {
