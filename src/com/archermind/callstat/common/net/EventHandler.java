...
public interface EventHandler {
	/**
	 * Error codes used in the error() callback. Positive error codes are
	 * reserved for codes sent by http servers. Negative error codes are
	 * connection/parsing failures, etc.
	 */
	 ...
	 * 
	 * @param major_version
	 *            HTTP version advertised by server. major is the part before
	 *            the "."
	 * @param minor_version
	 *            HTTP version advertised by server. minor is the part after the
	 *            "."
	 * @param code
	 *            HTTP Status code. See RFC 2616.
	 * @param reason_phrase
	 *            Textual explanation sent by server
	 */
	public void status(int major_version, int minor_version, int code,
	 ...
	 *            interface.
	 */
	public void endData(byte[] data, int len);
