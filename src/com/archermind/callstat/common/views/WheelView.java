...
package com.archermind.callstat.common.views;
...
import com.archermind.callstat.common.views.adapter.WheelAdapter;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF4F6486;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF4F6486;
	...
	/** Text size */
	private static final int TEXT_SIZE = 39;
	...
	// Shadows drawables
	/*
	 * private GradientDrawable topShadow; private GradientDrawable
	 * bottomShadow;
	 */
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.time_pick_up);
		}

		/*
		 * if (topShadow == null) { topShadow = new
		 * GradientDrawable(Orientation.TOP_BOTTOM, SHADOWS_COLORS); }
		 * 
		 * if (bottomShadow == null) { bottomShadow = new
		 * GradientDrawable(Orientation.BOTTOM_TOP, SHADOWS_COLORS); }
		 */

		setBackgroundResource(R.drawable.time_pick_bj);
		setPadding(3, 3, 3, 3);
	}
	 ...
	 */
	/*
	 * private void drawShadows(Canvas canvas) { topShadow.setBounds(0, 0,
	 * getWidth(), getHeight() / visibleItems); topShadow.draw(canvas);
	 * 
	 * bottomShadow.setBounds(0, getHeight() - getHeight() / visibleItems,
	 * getWidth(), getHeight()); bottomShadow.draw(canvas); }
	 */
