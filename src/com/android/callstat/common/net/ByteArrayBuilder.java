...
/**
 * Utility class optimized for accumulating bytes, and then spitting them back
 * out. It does not optimize for returning the result in a single array, though
 * this is supported in the API. It is fastest if the retrieval can be done via
